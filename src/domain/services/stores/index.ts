...
export const useServicesStore = defineStore("services", () => {
  ...
  const dummyServices: Service[] = [
    ...
    {id: "7d", thumbnail: ministryThumbnail, name: "Work Permit Application", description: "Application for a Work Permit", accessibilityTier: "Public", featureId: "7", requirements: ["National ID", "Passport"], providerId: "7", providerName: "Ministry of Internal Affairs", createdAt: {Time: "2021-09-03", Valid: true}, status: "listed", currentVersionId: "7"},
    ...
    {id: "7d", thumbnail: ursbThumbnail, name: "Patent Application", description: "Application for a Patent", accessibilityTier: "Public", featureId: "7", requirements: ["National ID", "Passport"], providerId: "7", providerName: "URSB", createdAt: {Time: "2021-09-03", Valid: true}, status: "listed", currentVersionId: "7"},
    {id: "7d", thumbnail: ministryThumbnail, name: "Visa Application", description: "Application for a Visa", accessibilityTier: "Public", featureId: "7", requirements: ["National ID", "Passport"], providerId: "7", providerName: "Ministry of Internal Affairs", createdAt: {Time: "2021-09-03", Valid: true}, status: "listed", currentVersionId: "7"},
  ...
  const dummySubscribedServices: Service[] = [
    ...
    {id: "2y", thumbnail: ursbThumbnail, name: "File Company Returns", description: "Register a Business", accessibilityTier: "Public", featureId: "5", requirements: ["National ID", "Passport"], providerId: "2", providerName: "URSB", createdAt: {Time: "2021-09-05", Valid: true}, status: "subscribed", currentVersionId: "2"},
     ];
