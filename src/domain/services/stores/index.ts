...
export const useServicesStore = defineStore("services", () => {
  ...
  const dummyServices: Service[] = [
    ...
    {id: "4a", name: "Driver's Permit Application", description: "Apply for a Driver's Permit", accessibilityTier: "Public", featureId: "7", requirements: ["National ID", "Passport"], providerId: "4", providerName: "Ministry of Works and Transport", createdAt: {Time: "2021-09-07", Valid: true}, status: "listed", currentVersionId: "4"},
  ];

  // const dummySubscribedServices: Ref<Service[]> = ref([]);

  const dummySubscribedServices: Service[] = [
    {id: "5b", name: "Post Office Account", description: "Open a Post Office Account", accessibilityTier: "Public", featureId: "5", requirements: ["National ID", "Passport"], providerId: "5", providerName: "Posta Uganda", createdAt: {Time: "2021-09-01", Valid: true}, status: "subscribed", currentVersionId: "5"},
